              ...
              children: [
                        ...
                        return MediaQuery.removePadding(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                Comment cmt = Comment.fromJson(snapshot.data!.docs[index]);
                                return Container(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image:
                                                DecorationImage(image: NetworkImage(widget.usrimg), fit: BoxFit.cover)),
                                      ),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Column(
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              var tf = TextEditingController(text: cmt.text);
                                              if (widget.uid == cmt.uid) {
                                                showDialog(
                                                    context: context,
                                                    builder: (context) {
                                                      return AlertDialog(
                                                        title: const Text('Edit Or Delete Comment!!'),
                                                        content: Column(
                                            ...
                                            child: Row(
                                              children: [
                                                Expanded(
                                                  flex: 1,
                                                  child: Text(
                                                    daysBetween(cmt.date.toDate(), DateTime.now()),
                                                ...
                                                Transform.translate(
                                                  ...
                                                  child: Expanded(
                                                    ...
                                                    child: ReactionButton<String>(
                                                      ...
                                                      placeholder: defaultInitialcommentReaction,
                                                      selectedReaction: reactionscomment.first,
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        decoration: BoxDecoration(color: Colors.grey.shade50, borderRadius: BorderRadius.circular(100)),
                        child: TextField(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      FirebaseFirestore.instance.collection('Posts').doc(widget.pst.postid).update({
                                        'Comment': widget.pst.comment + 1,
                                      });
                                    ...
                                    child: Icon(
                                      Icons.send_outlined,
                                      color: showcolor ? Colors.blue : Colors.black54,
                                      size: 28,
                                    ),
                                  ),
                                  const SizedBox(
